...
void bTaggerLocal (const std::string& submitDir)
{
  ...
  std::string grlFileName="bTagger/data17_5TeV.periodAllYear_DetStatus-v98-pro21-16_Unknown_PHYS_StandardGRL_All_Good_25ns_ignore_GLOBAL_LOWMU.xml";
  ...
  //  const char* inputFilePath = gSystem->ExpandPathName ("/usatlas/u/mphipps2/ML/analysisBase_bTagger/athena/bTagger/data/");
